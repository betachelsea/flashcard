...
RSpec.describe ParagraphsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all paragraphs as @paragraphs" do
      ...
      expect(assigns(:paragraphs)).to eq([paragraph])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested paragraph as @paragraph" do
      ...
      expect(assigns(:paragraph)).to eq(paragraph)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new paragraph as @paragraph" do
      ...
      expect(assigns(:paragraph)).to be_a_new(Paragraph)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      ...
      it "assigns a newly created paragraph as @paragraph" do
        post :create, {:paragraph => valid_attributes}, valid_session
        expect(assigns(:paragraph)).to be_a(Paragraph)
        expect(assigns(:paragraph)).to be_persisted
      end
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved paragraph as @paragraph" do
        post :create, {:paragraph => invalid_attributes}, valid_session
        expect(assigns(:paragraph)).to be_a_new(Paragraph)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested paragraph" do
        paragraph = Paragraph.create! valid_attributes
        put :update, {:id => paragraph.to_param, :paragraph => new_attributes}, valid_session
        paragraph.reload
    ...
    context "with invalid params" do
      it "assigns the paragraph as @paragraph" do
        paragraph = Paragraph.create! valid_attributes
        put :update, {:id => paragraph.to_param, :paragraph => invalid_attributes}, valid_session
        expect(assigns(:paragraph)).to eq(paragraph)
      end
